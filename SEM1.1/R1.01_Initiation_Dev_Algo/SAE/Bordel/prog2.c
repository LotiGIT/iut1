/*
	...
	par des listes chaines dynamiques et propose plusieurs
...
#define TMAX 20	/*\def taille maximum d'une chaine = 20 caractères*/ 
                // Taille Maximum d'une chaine quand on veut
				// ordonner ses caractères

typedef struct Elem {		// structure d'un élément de la   /* \struct \var lettre correspond au caractère mémorisé et */
    char lettre;			// liste chaine. Composée d'un    /*\var svt est un pointeur sur le caractère suivant de la liste chainée*/
...
// concat�ne deux chaines en une troisième
